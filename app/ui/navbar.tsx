...
export default function Navbar() {
  ...
  return (
    <nav className={clsx('sticky top-0 z-[100]', scrollPosition === 0 ? 'bg-transparent' : 'bg-[#0d1224]')}>
      ...
      <div className={clsx('flex justify-center z-[100]', scrollPosition === 0 || isDrawerOpen ? 'hidden' : '')}>
